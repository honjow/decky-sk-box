...
class Plugin:
    async def _main(self):
        ...
        decky.logger.info("Plugin initialized with GPU manager")
    ...
    async def set_settings(self, settings):
        ...
        logger.log(f"save Settings: {settings}")
        return True
    ...
    async def set_handycon_enabled(self, enabled: bool):
        try:
            ...
            logger.error(f"Error setting HandyCon enabled: {e}")
            return False
    ...
    async def set_inputplumber_enabled(self, enabled: bool):
        try:
            ...
            logger.error(f"Error setting Input Plumber enabled: {e}")
            return False
    ...
    async def set_hhd_enabled(self, enabled: bool):
        try:
            ...
            logger.error(f"Error setting HHD enabled: {e}", exc_info=True)
            return False
    ...
    async def get_auto_keep_boot_enabled(self):
        try:
            ...
            logger.error("Error getting Auto Keep Boot enabled", exc_info=True)
            return False

    async def set_auto_keep_boot_enabled(self, enabled: bool):
        logger.info(f"Setting Auto Keep Boot enabled: {enabled}")
        try:
            utils.toggle_service("sk-setup-next-boot.service", enabled)
            return True
        except Exception as e:
            logger.error(f"Error setting Auto Keep Boot enabled: {e}")
            return False
    ...
    async def set_hibernate_enabled(self, enabled: bool):
        try:
            ...
            logger.error(f"Error setting Hibernate enabled: {e}")
            return False

    async def get_sleep_mode(self) -> str:
        try:
            result = utils.get_sleep_mode()
            logger.info(f"获取休眠类型: {result}")
            return result.value
        except Exception:
            logger.error("Error getting Sleep Mode", exc_info=True)
            return SleepMode.SUSPEND.value

    async def set_sleep_mode(self, sleep_mode: str):
        logger.info(f"Setting Sleep Mode: {sleep_mode}")
        try:
            mode: SleepMode = SleepMode(sleep_mode)
            utils.set_sleep_mode(mode)
            return True
        except Exception as e:
            logger.error(f"Error setting Sleep Mode: {e}")
            return False
    ...
    async def set_firmware_override(self, enabled: bool):
        try:
            ...
            logger.error(f"Error setting Firmware Override enabled: {e}")
            return False
    ...
    async def set_enable_auto_update(self, enabled: bool):
        logger.info(f"Setting Auto Update enabled: {enabled}")
        try:
            utils.toggle_service("sk-chos-tool-autoupdate.timer", enabled)
            return True
        except Exception as e:
            logger.error(f"Error setting Auto Update enabled: {e}")
            return False
    ...
    async def set_skt_update_enabled(self, enabled: bool):
        ...
        try:
            ...
            logger.error(f"Error setting SKT Update enabled: {e}")
            return False
    ...
    async def set_handy_update_enabled(self, enabled: bool):
        ...
        try:
            ...
            logger.error(f"Error setting Handy Update enabled: {e}")
            return False
    ...
    async def set_hhd_update_enabled(self, enabled: bool):
        ...
        try:
            ...
            logger.error(f"Error setting HHD Update enabled: {e}")
            return False
    ...
    async def get_frzr_config_structure(self):
        ...
        try:
            ...
            logger.error(f"Error getting frzr config structure: {e}")
            return {}
    ...
    async def set_frzr_config(self, section: str, key: str, value: str):
        ...
        try:
            ...
            logger.error(f"Error setting frzr config: {e}")
            return False
    ...
    async def get_frzr_metadata(self):
        ...
        try:
            ...
            logger.error(f"Error getting frzr metadata: {e}")
            return {}
    ...
    async def boot_repair(self):
        try:
            ...
            logger.error(f"Error repairing boot: {e}")
            return False
    ...
    async def re_first_run(self):
        try:
            ...
            if code != 0:
                logger.error(f"Error resetting first run: {msg}")
                return False
            return True
        except Exception as e:
            logger.error(f"Error resetting first run: {e}")
            return False
    ...
    async def etc_repair(self):
        try:
            ...
            logger.error(f"Error repairing etc: {e}")
            return False
    ...
    async def make_swapfile(self):
        logger.info("Making swapfile")
        try:
            utils.make_swapfile()
            return True
        except Exception as e:
            logger.error(f"Error making swapfile: {e}")
            return False

    async def make_swapfile_with_size(self, size_gb: int):
        """Create swapfile with specified size"""
        logger.info(f"User requested swapfile creation with size: {size_gb}GB")
        try:
    ...
    async def reset_dconf(self):
        ...
        try:
            ...
            logger.error(f"Error resetting dconf: {e}")
            return False
    ...
    async def has_gnome_shell(self):
        try:
            ...
            logger.error(f"Error checking gnome shell: {e}")
            return False
    ...
    async def get_gnome_extensions_enabled(self):
        try:
            ...
            logger.error(f"Error getting gnome extensions state: {e}")
            return True

    async def set_gnome_extensions_enabled(self, enabled: bool):
        logger.info(f"Setting GNOME extensions enabled: {enabled}")
        try:
            return utils.set_gnome_extensions_enabled(enabled)
        except Exception as e:
            logger.error(f"Error setting gnome extensions state: {e}")
            return False
    ...
    async def get_win_boot(self):
        try:
            ...
            logger.error(f"Error getting windows boot: {e}")
            return ""
    ...
    async def boot_to_win(self):
        try:
            ...
            logger.error(f"Error booting to windows: {e}")
            return False
    ...
    async def get_mountpoint(self):
        try:
            ...
            logger.error(f"Error getting mountpoint: {e}")
            import traceback
    ...
    async def add_library_folder(self, mountpoint: str):
        logger.info(f"Adding library folder: {mountpoint}")
        try:
            return steam_util.add_library_folder(mountpoint)
        except Exception as e:
            logger.error(f"Error adding library folder: {e}")
            # 堆栈跟踪
            import traceback
    ...
    async def set_hibernate_delay(self, delay: str):
        logger.info(f"Setting Hibernate delay: {delay}")
        try:
            utils.set_hibernate_delay(delay)
            return True
        except Exception as e:
            logger.error(f"Error setting Hibernate delay: {e}")
            return False

    async def get_hibernate_delay(self) -> str:
        try:
            result = utils.get_hibernate_delay()
            logger.info(f"获取休眠延迟: {result}")
            return result
        except Exception as e:
            logger.error(f"Error getting Hibernate delay: {e}")
            return ""
    ...
    async def support_umaf(self):
        try:
            ...
            logger.error(f"Error getting umaf support: {e}")
            return False
    ...
    async def boot_umaf(self):
        try:
            ...
            logger.error(f"Error booting umaf: {e}")
            return False
    ...
    async def can_switch_desktop_session(self):
        try:
            ...
            logger.error(f"Error checking desktop session switcher: {e}")
            return False
    ...
    async def set_desktop_session(self, session: str):
        try:
            ...
            logger.error(f"Error setting desktop session: {e}")
            return False
    ...
    async def get_gpu_devices(self):
        try:
            logger.info("Getting GPU devices via GPU manager")
    ...
    async def set_vulkan_adapter(self, device_id: str):
        try:
            logger.info(f"Setting Vulkan adapter via GPU manager: {device_id}")
            return self.gpu_manager.set_vulkan_adapter(device_id)
        except Exception as e:
            logger.error(f"Error setting Vulkan adapter: {e}", exc_info=True)
            return False

    # get_current_vulkan_adapter
    async def get_current_vulkan_adapter(self):
        try:
            logger.info("Getting current Vulkan adapter via GPU manager")
            return self.gpu_manager.get_current_vulkan_adapter()
        except Exception as e:
            logger.error(f"Error getting current Vulkan adapter: {e}", exc_info=True)
            return ""
    ...
    async def execute_hibernate(self):
        ...
        logger.info("User requested system hibernation")
        try:
    ...
    async def get_current_orientation(self):
        ...
        try:
            ...
            logger.error(f"Error getting current orientation: {e}")
            return ""
    ...
    async def set_orientation_override(self, orientation: str):
        ...
        try:
            logger.info(f"Setting orientation override: {orientation}")
            return utils.set_orientation_override(orientation)
        except Exception as e:
            logger.error(f"Error setting orientation override: {e}")
            return False
